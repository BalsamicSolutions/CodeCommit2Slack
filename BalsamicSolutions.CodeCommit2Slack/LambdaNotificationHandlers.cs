...
namespace BalsamicSolutions.CodeCommit2Slack
{
    ...
    /// notifications.
    ///
    /// Slack configuration for this class relies on an enviornment variable
    /// named SlackChannelUrl  that contains the url to the Slack Channel.  The
    /// Slack Channel App must be created  with  https://api.slack.com/apps and
    ...
    public class LambdaNotificationHandlers
    {
        ...
        private readonly Uri _SlackUrl = null;
        ...
        public LambdaNotificationHandlers()
        {
            ...
            tempVal = Environment.GetEnvironmentVariable("SlackChannelUrl");
            if (!tempVal.IsNullOrWhiteSpace())
            {
                tempVal = tempVal.Trim();
                try
                {
                    _SlackUrl = new Uri(tempVal);
                    Console.WriteLine("SlackChannelUrl set to " + _SlackUrl.ToString());
                ...
                {
                    Console.WriteLine("Invalid url found in environment variable SlackChannelUrl");
                }
            }
            else
            {
                Console.WriteLine("Missing environment variable SlackChannelUrl");
            }
        }
        ...
        public LambdaNotificationHandlers(AWSCredentials awsCreds, string slackChannelUrl)
        {
            ...
            _SlackUrl = _SlackUrl = new Uri(slackChannelUrl); ;
            _Enabled = true;
        ...
        /// BalsamicSolutions.CodeCommit2Slack::BalsamicSolutions.CodeCommit2Slack.LambdaNotificationHandlers::HandleBranchEvent
        /// </summary>
        ...
        ///
        /// Use this name to register with Lambda
        ///  BalsamicSolutions.CodeCommit2Slack::BalsamicSolutions.CodeCommit2Slack.LambdaNotificationHandlers::HandlePullEvent
        /// </summary>
